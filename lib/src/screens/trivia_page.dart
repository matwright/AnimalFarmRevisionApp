...
class TriviaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bloc.triviaState.onChange((onDataChanged){
      ...
      if(ended==false && ModalRoute.of(context).settings.name=="/trivia" &&  onDataChanged.isTriviaEnd==true){
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Container(
                                      ...
                                      child: AnswersWidget(
                                        ...
                                        isTriviaEnd: snapshotTrivia.data.isTriviaEnd,
                                      ));
                                });}),
                    ),
                    ValueBuilder<int>(
