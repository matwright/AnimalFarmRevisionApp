...
List<Map<String, dynamic>> locations = [
  {
    ...
    "image": "orchard.png",
    "strap_line":
        "The orchard is where Old Major is buried and from where the pigs take the apples for themselves."
  },
  {
    "id": "stables",
    "name": "Stables",
  ...
  },
  {
    ...
    "strap_line":
        "The small paddock, which was originally set aside for the animals’ retirement, in the end was planted with barley for the pigs."
  },
  {
    "id": "farmhouse_garden",
    "name": "The Garden",
    ...
    "strap_line":
        "The farmhouse garden is where the flag is raised, the gun is fired on special days, and where the animals file passed old major’s skull."
  },
  {
    "id": "yard",
    "name": "The Yard",
    "image": "yard.png",
    "strap_line":
        "The farmhouse and other buildings are all arranged around the yard. The yard is the location of the Battle of the Cowshed"
  },
  {
    "id": "cowshed",
    "name": "The Cowshed",
    "image": "cowshed.png",
    "strap_line":
        "The cowshed is where the animals hide at the beginning of the Battle of the Cowshed, hence the name of the battle."
  },
  {
    "id": "hen_house",
    "name": "Hen House",
    "image": "orchard.png",
    "strap_line":
        "The hen house is where the hens’ protest takes place. They refuse to give 400 eggs a week to be sold at market"
  },
  {
    "id": "windmill",
    "name": "The Windmill",
    "image": "windmill.png",
    "strap_line":
        "The windmill represents industry and technology. It shows how hard the animals work, having to adapt human equipment to their own needs and having to build the windmill on top of their other tasks."
  },
  {
    "id": "store_shed",
    "name": "The Store Shed",
    ...
    "strap_line":
        "The cows break down the door of the store shed when the animals haven’t been fed for two days."
  },
  {
    "id": "foxwood_farm",
    "name": "Foxwood Farm",
    ...
    "strap_line":
        "Foxwood Farm is one of the neighbouring farms. It’s run by Pilkington and represents the British Empire. It’s large, old-fashioned and in a bad condition due to neglect."
  },
  {
    "id": "pinchfield_farm",
    ...
    "strap_line":
        "Pinchfield Farm one of the neighbouring farms is run by Frederick and represents Germany. Pinchfield is small and well-run."
  },
  {
    "id": "barn",
    "name": "The Barn",
    "image": "barn.png",
    "strap_line":
        "The barn represents the animals’ ideal world where animals are not controlled by man. It is where Old Major made his speech."
  },
  {
    "id": "farmhouse",
    "name": "The Farmhouse",
    "image": "farmhouse.png",
    "strap_line":
        "The farmhouse represents how the ruling class lived in luxury. It shows the gulf between the animals lives and that of Jones. It also shows the power relationship between the pigs and the other animals."
  },
  {
    "id": "red_lion_inn",
    "name": "Red Lion Inn",
    "image": "pinchfield_farm.png",
    "strap_line":
        "The red lion inn is where Jones stays when he is driven out of Animal farm. The farmers meet here regularly to discuss Animal Farm."
  },
];
List<Map<String, dynamic>> characters = [
  ...
  },
  {
    ...
    "strap_line": "All animals are equal.",
  ...
  },
  {
    ...
    "strap_line": "Oooh Sugarcandy Mountain",
  ...
  },
  {
    ...
    "strap_line": "Donkeys live a long time.",
  ...
  },
  {
    ...
    "strap_line": "Here's to Animal Farm!",
...
List<Map<String, dynamic>> awardsData = [
  ...
  },
  {
    ...
    "description":
        "Mollie is a vain and shallow horse, obsessed with how she looks. This award recognises those who take time to choose how they look."
  },
  {
    ...
    "description":
        "Boxer is a loyal supporter of the revolution and the hardest worker on the farm. This award recognises hard work."
  },
  {
    ...
    "description":
        "The animals drive Jones off the farm after he forgot to feed them as he was drunk. This award recognises ambition."
  },
  {
    ...
    "description":
        "The pigs create Animalism from Old Major's speech. It represents communism. This award recognises progress."
  },
  {
    ...
    "description":
        "Animal Farm is an allegory for the Russian Revolution. This award recognises uprising through knowledge."
  },
  {
    ...
    "description":
        "Manor Farm is renamed Animal Farm after the revolution. This award recognises transformation."
  },
  {
    ...
    "description":
        "Snowball, Napoleon and Squealer turned Old Major's ideas into the seven commandments. This award recognises commitment."
  },
  {
    ...
    "description":
        "The pigs take the milk and apples because they are the most intelligent and the milk and apples helps with their intelligence. This award recognises intelligence."
  },
  {
    ...
    "description":
        "The humans, led by Mr Jones, attempted to take the farm back by force. The animals were waiting for them and chased them out. This award recognises forsight."
  },
  {
    ...
    "description":
        "Snowball designed the windmill because he believed it would increase productivity, ultimately leading to a three-day week. This award recognises productivity."
  },
  {
    ...
    "description":
        "Napoleon introduces work on Sunday afternoons. He says it’s voluntary but rations are halved if they refuse. This award recognises increased work."
  },
  {
    ...
    "description":
        "Napoleon demanded the hens gave up all their eggs. The Hens rebelled by laying the eggs from the rafters so they all smashed on the floor. This award recognises audacity."
  },
  {
    "id": awardTrigger.hundredCorrectAnswers,
    ...
    "description":
        "Father of all Animals is one of the names the pigs invented for Napoleon. This award recognises mastery."
  },
  {
    ...
    "description":
        "Snowball and Boxer receive this medal for their efforts in the Battle of the Cowshed. This award recognises effort & success!"
  }
];
